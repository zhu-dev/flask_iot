...
from huawei_sdk.client.dto.DeleteBatchSubInDTO import DeleteBatchSubInDTO
from huawei_sdk.client.dto.QueryBatchSubInDTO import QueryBatchSubInDTO
...
class SubscriptionManagementTest(object):
    def subDeviceBusinessData(self):
        ...
        sdbdInDTO.notifyType = "deviceDataChanged"
